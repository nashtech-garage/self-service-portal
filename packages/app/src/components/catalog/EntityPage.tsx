...
import { EntityGrafanaDashboardsCard, EntityGrafanaAlertsCard  } from '@backstage-community/plugin-grafana';
...
const gitHubActionEntityPage = (
  <EntityLayout>
    ...
    <EntityLayout.Route path="/github-actions" title="CI/CD">
    <EntityGithubActionsContent />
    </EntityLayout.Route>
...
const componentPage = (
  <EntitySwitch>
    ...
    <EntitySwitch.Case if={isComponentType('github')}>
      {gitHubActionEntityPage}
    </EntitySwitch.Case>
